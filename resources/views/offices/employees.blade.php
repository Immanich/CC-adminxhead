...
<div class="container mx-auto mt-2">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-8 p-3">
        ...
        <div class="bg-white p-4 rounded-lg shadow-lg text-center hover:shadow-xl transition-shadow duration-300 transform hover:scale-105">
            <div class="mb-4">
                <!-- Profile Image -->
                <img src="{{ asset('storage/' . $employee->image) }}" alt="Profile Image" class="w-24 h-24 rounded-full object-cover mx-auto">
            ...
            <div class="mt-4 flex justify-center space-x-2">
                <button onclick="openEditModal({{ $employee }})" class="bg-yellow-500 text-white py-1 px-3 rounded hover:bg-yellow-600">Edit</button>
