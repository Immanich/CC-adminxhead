...
@section('content')
    <div class="flex flex-col items-center mt-8 mb-6">
        <a href="{{ route('pending.events') }}" class="self-start ml-5 rounded-full bg-gray-600 py-2 px-4 text-white hover:bg-slate-700">
        ...
        <p class="text-lg font-semibold text-yellow-600 mt-1">Status: Pending</p>
    </div>
