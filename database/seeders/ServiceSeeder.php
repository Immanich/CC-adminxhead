    ...
    public function run(): void
    {
        ...
        $assessors = Office::where('id', 2)->first();
            ...
            Service::create([
                ...
                'type_of_transaction' => $g2gTransaction->type_of_transaction,
...
// }
        ...
        //     ],
        //     [
        //         'service_name' => 'REVIEW OF FINANCIAL TRANSACTIONS',
        //         'description' => "Reviewing financial transactions for compliance with accounting standards and regulations.",
        //         'office_id' => 1,
        //         'classification' => 'SIMPLE',
        //         'transaction_id' => $transaction->id,
        //         'checklist_of_requirements' => json_encode([
